...
*   [TOM88812/xiaozhi-android-client](https://github.com/TOM88812/xiaozhi-android-client) - 一个基于xiaozhi-server的Android语音对话应用,支持实时语音交互和文字对话。欢迎👏👏👏starred，和PR，这样才有动力继续输出。目前只是伪修复回音，如果有大神PR，欢迎指教。
